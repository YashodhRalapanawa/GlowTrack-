...
/**
 * Enhanced adapter for mood history list with improved styling
 */
class MoodHistoryAdapterEnhanced(
    private val onDeleteClick: (MoodEntry) -> Unit,
    private val onShareClick: (MoodEntry) -> Unit
) : RecyclerView.Adapter<MoodHistoryAdapterEnhanced.MoodHistoryViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoodHistoryViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_mood_history_enhanced, parent, false)
