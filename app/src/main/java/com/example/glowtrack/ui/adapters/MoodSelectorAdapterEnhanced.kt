...
/**
 * Enhanced adapter for mood selector grid with improved UX and animations
 */
class MoodSelectorAdapterEnhanced(
    private val onMoodSelected: (MoodType) -> Unit
) : RecyclerView.Adapter<MoodSelectorAdapterEnhanced.MoodSelectorViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoodSelectorViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_mood_selector_enhanced, parent, false)
